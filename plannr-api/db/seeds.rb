...
plan1 = Plan.create(title: "Get Coffee", description: 'not flatiron trash coffee', location: "la colombe", date_time: "17 Dec 2018 12:00PM -0400", admin_id: jason.id )
plan2 = Plan.create(title: "Chipotle/El Toro for lunch?", description: "I like chipototle", location: "chipotle", date_time: "17 Dec 2018 1:00PM -0400", admin_id: jason.id)
plan3 = Plan.create(title: "Picnic at Prospect Park", description: "should be dope", location: "prospect park", date_time: "11 Dec 2018 12:00PM -0400", admin_id: josh.id)
